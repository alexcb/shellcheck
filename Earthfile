aarch64-linux-gnu-deps:
    ...
    SAVE IMAGE --push alexcb132/test-shellcheck:aarch64-linux-gnu-deps
...
x86-64-linux-deps:
    ...
    # push up a new layer so it can be cached for future runs
    SAVE IMAGE --push alexcb132/test-shellcheck:x86-64-linux-deps
...
x86-64-windows-deps:
    ...
    # push up a new layer so it can be cached for future runs
    SAVE IMAGE --push alexcb132/test-shellcheck:windows-deps
